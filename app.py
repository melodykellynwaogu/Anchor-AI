...
qa_pairs = {
    "hi": "Hello! I am Anchor. How can I help you?",
    ...
    "what is your farvorite food": "I don't eat, but if I did, I would really like pizza.",
...
def get_wikipedia_summary(query):
    try:
        ...
        return f"That topic seems unclear. Try asking about something more specific like '{e.options[0]}'."
